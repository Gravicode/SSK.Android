...
public class TestUtils {
    ...
    /* renamed from: t */
    public static double m60t(double mu, double[] observed) throws NullArgumentException, NumberIsTooSmallException {
        return T_TEST.mo19616t(mu, observed);
    }

    /* renamed from: t */
    public static double m59t(double mu, StatisticalSummary sampleStats) throws NullArgumentException, NumberIsTooSmallException {
        return T_TEST.mo19615t(mu, sampleStats);
    }

    /* renamed from: t */
    public static double m62t(double[] sample1, double[] sample2) throws NullArgumentException, NumberIsTooSmallException {
        return T_TEST.mo19618t(sample1, sample2);
    }

    /* renamed from: t */
    public static double m61t(StatisticalSummary sampleStats1, StatisticalSummary sampleStats2) throws NullArgumentException, NumberIsTooSmallException {
        return T_TEST.mo19617t(sampleStats1, sampleStats2);
    }
    ...
    /* renamed from: g */
    public static double m58g(double[] expected, long[] observed) throws NotPositiveException, NotStrictlyPositiveException, DimensionMismatchException {
        return G_TEST.mo19571g(expected, observed);
    }
