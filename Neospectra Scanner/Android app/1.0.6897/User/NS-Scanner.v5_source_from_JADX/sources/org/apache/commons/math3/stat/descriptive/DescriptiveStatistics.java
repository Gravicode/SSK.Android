...
public class DescriptiveStatistics implements StatisticalSummary, Serializable {
    ...
    public String toString() {
        ...
        try {
            ...
            outBuffer.append(getPercentile(50.0d));
            outBuffer.append(endl);
        ...
        outBuffer.append(getSkewness());
        outBuffer.append(endl);
        outBuffer.append("kurtosis: ");
        outBuffer.append(getKurtosis());
        outBuffer.append(endl);
    ...
    public synchronized void setPercentileImpl(UnivariateStatistic percentileImpl2) throws MathIllegalArgumentException {
        try {
            percentileImpl2.getClass().getMethod(SET_QUANTILE_METHOD_NAME, new Class[]{Double.TYPE}).invoke(percentileImpl2, new Object[]{Double.valueOf(50.0d)});
