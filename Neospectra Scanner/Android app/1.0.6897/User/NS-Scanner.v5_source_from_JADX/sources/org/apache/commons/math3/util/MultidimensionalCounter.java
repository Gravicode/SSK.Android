...
public class MultidimensionalCounter implements Iterable<Integer> {
    ...
    public int[] getCounts(int index) throws OutOfRangeException {
        if (index < 0 || index >= this.totalSize) {
            throw new OutOfRangeException(Integer.valueOf(index), Integer.valueOf(0), Integer.valueOf(this.totalSize));
        }
    ...
    public int getCount(int... c) throws OutOfRangeException, DimensionMismatchException {
        ...
        for (int i = 0; i < this.dimension; i++) {
            ...
            if (index < 0 || index >= this.size[i]) {
                throw new OutOfRangeException(Integer.valueOf(index), Integer.valueOf(0), Integer.valueOf(this.size[i] - 1));
            }
