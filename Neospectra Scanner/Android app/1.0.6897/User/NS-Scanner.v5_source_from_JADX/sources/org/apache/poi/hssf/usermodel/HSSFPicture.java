...
import org.apache.poi.p009ss.usermodel.Picture;
import org.apache.poi.p009ss.util.ImageUtils;
...
public final class HSSFPicture extends HSSFSimpleShape implements Picture {
    ...
    public HSSFClientAnchor getPreferredSize(double scale) {
        ...
        if (((double) w) > scaledWidth) {
            ...
            dx2 = (int) (((cw - (((double) w) - scaledWidth)) / cw) * 1024.0d);
        }
        anchor.col2 = col2;
        anchor.dx2 = dx2;
        ...
        if (((double) h) > scaledHeight) {
            ...
            float f = h;
            dy2 = (int) (((ch - (((double) h) - scaledHeight)) / ch) * 256.0d);
        } else {
            dy2 = 0;
        }
        anchor.row2 = row2;
