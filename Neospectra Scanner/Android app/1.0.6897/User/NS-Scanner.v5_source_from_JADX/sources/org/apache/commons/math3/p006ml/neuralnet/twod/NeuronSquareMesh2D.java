package org.apache.commons.math3.p006ml.neuralnet.twod;
...
import org.apache.commons.math3.p006ml.neuralnet.FeatureInitializer;
import org.apache.commons.math3.p006ml.neuralnet.Network;
import org.apache.commons.math3.p006ml.neuralnet.Neuron;
import org.apache.commons.math3.p006ml.neuralnet.SquareNeighbourhood;
...
public class NeuronSquareMesh2D implements Iterable<Neuron>, Serializable {
    ...
    NeuronSquareMesh2D(boolean wrapRowDim, boolean wrapColDim, SquareNeighbourhood neighbourhoodType, double[][][] featuresList) {
        ...
        if (this.numberOfRows < 2) {
            ...
            this.identifiers = (long[][]) Array.newInstance(long.class, new int[]{this.numberOfRows, this.numberOfColumns});
    ...
    public synchronized NeuronSquareMesh2D copy() {
        NeuronSquareMesh2D neuronSquareMesh2D;
        long[][] idGrid = (long[][]) Array.newInstance(long.class, new int[]{this.numberOfRows, this.numberOfColumns});
        for (int r = 0; r < this.numberOfRows; r++) {
            for (int c = 0; c < this.numberOfColumns; c++) {
                idGrid[r][c] = this.identifiers[r][c];
            }
        }
        neuronSquareMesh2D = new NeuronSquareMesh2D(this.wrapRows, this.wrapColumns, this.neighbourhood, this.network.copy(), idGrid);
        return neuronSquareMesh2D;
    }
