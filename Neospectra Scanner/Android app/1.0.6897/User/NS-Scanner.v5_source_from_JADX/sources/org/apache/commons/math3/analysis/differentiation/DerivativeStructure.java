...
public class DerivativeStructure implements RealFieldElement<DerivativeStructure>, Serializable {
    ...
    public DerivativeStructure(double a1, DerivativeStructure ds1, double a2, DerivativeStructure ds2) throws DimensionMismatchException {
        DerivativeStructure derivativeStructure = ds1;
        DerivativeStructure derivativeStructure2 = ds2;
        this(derivativeStructure.compiler);
        this.compiler.checkCompatibility(derivativeStructure2.compiler);
        this.compiler.linearCombination(a1, derivativeStructure.data, 0, a2, derivativeStructure2.data, 0, this.data, 0);
    }
    ...
    public DerivativeStructure(double a1, DerivativeStructure ds1, double a2, DerivativeStructure ds2, double a3, DerivativeStructure ds3) throws DimensionMismatchException {
        DerivativeStructure derivativeStructure = ds1;
        DerivativeStructure derivativeStructure2 = ds2;
        DerivativeStructure derivativeStructure3 = ds3;
        this(derivativeStructure.compiler);
        this.compiler.checkCompatibility(derivativeStructure2.compiler);
        this.compiler.checkCompatibility(derivativeStructure3.compiler);
        this.compiler.linearCombination(a1, derivativeStructure.data, 0, a2, derivativeStructure2.data, 0, a3, derivativeStructure3.data, 0, this.data, 0);
    }
    ...
    public DerivativeStructure(double a1, DerivativeStructure ds1, double a2, DerivativeStructure ds2, double a3, DerivativeStructure ds3, double a4, DerivativeStructure ds4) throws DimensionMismatchException {
        ...
        DerivativeStructure derivativeStructure2 = ds2;
        DerivativeStructure derivativeStructure3 = ds3;
        DerivativeStructure derivativeStructure4 = ds4;
        this(derivativeStructure.compiler);
        this.compiler.checkCompatibility(derivativeStructure2.compiler);
        this.compiler.checkCompatibility(derivativeStructure3.compiler);
        this.compiler.checkCompatibility(derivativeStructure4.compiler);
        DSCompiler dSCompiler = this.compiler;
        double[] dArr = derivativeStructure.data;
        double[] dArr2 = derivativeStructure2.data;
        double[] dArr3 = derivativeStructure3.data;
        dSCompiler.linearCombination(a1, dArr, 0, a2, dArr2, 0, a3, dArr3, 0, a4, derivativeStructure4.data, 0, this.data, 0);
    }
