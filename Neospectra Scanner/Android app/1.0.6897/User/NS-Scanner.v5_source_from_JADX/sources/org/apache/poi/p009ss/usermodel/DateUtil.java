...
/* renamed from: org.apache.poi.ss.usermodel.DateUtil */
public class DateUtil {
    ...
    /* renamed from: org.apache.poi.ss.usermodel.DateUtil$FormatException */
    ...
    private static double internalGetExcelDate(Calendar date, boolean use1904windowing) {
        ...
        double value = ((double) absoluteDay(dayStart(date), use1904windowing)) + (((double) ((((((date.get(11) * 60) + date.get(12)) * 60) + date.get(13)) * 1000) + date.get(14))) / 8.64E7d);
    ...
    public static boolean isCellDateFormatted(Cell cell) {
        ...
        if (isValidExcelDate(cell.getNumericCellValue())) {
            ...
            bDate = isADateFormat(style.getDataFormat(), style.getDataFormatString());
        }
        return bDate;
    }
    ...
    public static boolean isCellInternalDateFormatted(Cell cell) {
        ...
        boolean bDate = false;
        if (isValidExcelDate(cell.getNumericCellValue())) {
            bDate = isInternalDateFormat(cell.getCellStyle().getDataFormat());
        }
        return bDate;
    }
    ...
    public static double convertTime(String timeStr) {
        try {
            ...
            sb.append("Bad time format '");
            sb.append(timeStr);
            sb.append("' expected 'HH:MM' or 'HH:MM:SS' - ");
    ...
    private static double convertTimeInternal(String timeStr) throws FormatException {
        ...
        switch (parts.length) {
            ...
            default:
                StringBuilder sb = new StringBuilder();
                sb.append("Expected 2 or 3 fields but got (");
        ...
        return ((double) ((((hours * 60) + parseInt(minStr, "minute", 60)) * 60) + parseInt(secStr, "second", 60))) / 86400.0d;
    }
    ...
    private static Date parseYYYYMMDDDateInternal(String timeStr) throws FormatException {
        ...
        int i = year;
        GregorianCalendar gregorianCalendar = new GregorianCalendar(i, parseInt(monthStr, "month", 1, 12) - 1, parseInt(dayStr, "day", 1, 31), 0, 0, 0);
    ...
    private static int parseInt(String strVal, String fieldName, int lowerLimit, int upperLimit) throws FormatException {
        try {
            ...
            sb2.append("Bad int format '");
            sb2.append(strVal);
            sb2.append("' for ");
            sb2.append(fieldName);
            sb2.append(" field");
            throw new FormatException(sb2.toString());
        }
    }
}
