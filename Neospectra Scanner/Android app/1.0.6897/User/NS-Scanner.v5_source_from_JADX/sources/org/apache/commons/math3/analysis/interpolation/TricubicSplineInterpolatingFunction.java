...
public class TricubicSplineInterpolatingFunction implements TrivariateFunction {
    ...
    public TricubicSplineInterpolatingFunction(double[] x, double[] y, double[] z, double[][][] f, double[][][] dFdX, double[][][] dFdY, double[][][] dFdZ, double[][][] d2FdXdY, double[][][] d2FdXdZ, double[][][] d2FdYdZ, double[][][] d3FdXdYdZ) throws NoDataException, DimensionMismatchException, NonMonotonicSequenceException {
        ...
        double[][][] dArr4 = dFdY;
        double[][][] dArr5 = dFdZ;
        double[][][] dArr6 = d2FdXdY;
        double[][][] dArr7 = d2FdXdZ;
        double[][][] dArr8 = d2FdYdZ;
        double[][][] dArr9 = d3FdXdYdZ;
        int xLen = x.length;
        int yLen = y.length;
        int zLen = dArr.length;
        if (xLen == 0 || yLen == 0 || dArr.length == 0 || dArr2.length == 0) {
            ...
            if (dArr2[0].length == 0) {
            ...
            } else if (xLen != dArr9.length) {
                throw new DimensionMismatchException(xLen, dArr9.length);
            } else {
                ...
                int lastK = zLen2 - 1;
                int i5 = xLen;
                this.splines = (TricubicSplineFunction[][][]) Array.newInstance(TricubicSplineFunction.class, new int[]{zLen3, lastJ, lastK});
                int i6 = 0;
                while (i6 < zLen3) {
                    if (dArr2[i6].length != yLen) {
                        throw new DimensionMismatchException(dArr2[i6].length, yLen);
                    } else if (dArr3[i6].length != yLen) {
                        throw new DimensionMismatchException(dArr3[i6].length, yLen);
                    } else if (dArr4[i6].length != yLen) {
                        throw new DimensionMismatchException(dArr4[i6].length, yLen);
                    } else if (dArr5[i6].length != yLen) {
                        throw new DimensionMismatchException(dArr5[i6].length, yLen);
                    } else if (dArr6[i6].length != yLen) {
                        throw new DimensionMismatchException(dArr6[i6].length, yLen);
                    } else if (dArr7[i6].length != yLen) {
                        throw new DimensionMismatchException(dArr7[i6].length, yLen);
                    } else if (dArr8[i6].length != yLen) {
                        throw new DimensionMismatchException(dArr8[i6].length, yLen);
                    } else if (dArr9[i6].length != yLen) {
                        throw new DimensionMismatchException(dArr9[i6].length, yLen);
                    } else {
                        int ip1 = i6 + 1;
                        int j = 0;
                        while (j < lastJ) {
                            ...
                            int lastI = zLen3;
                            int lastI2 = zLen2;
                            if (dArr2[i6][j].length != lastI2) {
                                int i7 = lastJ;
                                throw new DimensionMismatchException(dArr2[i6][j].length, lastI2);
                            }
                            int lastJ2 = lastJ;
                            if (dArr3[i6][j].length != lastI2) {
                                throw new DimensionMismatchException(dArr3[i6][j].length, lastI2);
                            } else if (dArr4[i6][j].length != lastI2) {
                                throw new DimensionMismatchException(dArr4[i6][j].length, lastI2);
                            } else if (dArr5[i6][j].length != lastI2) {
                                throw new DimensionMismatchException(dArr5[i6][j].length, lastI2);
                            } else if (dArr6[i6][j].length != lastI2) {
                                throw new DimensionMismatchException(dArr6[i6][j].length, lastI2);
                            } else if (dArr7[i6][j].length != lastI2) {
                                throw new DimensionMismatchException(dArr7[i6][j].length, lastI2);
                            } else if (dArr8[i6][j].length != lastI2) {
                                throw new DimensionMismatchException(dArr8[i6][j].length, lastI2);
                            } else if (dArr9[i6][j].length != lastI2) {
                                throw new DimensionMismatchException(dArr9[i6][j].length, lastI2);
                            } else {
                                int jp1 = j + 1;
                                int k = 0;
                                while (k < lastK) {
                                    int kp1 = k + 1;
                                    int lastK2 = lastK;
                                    this.splines[i6][j][k] = new TricubicSplineFunction(computeSplineCoefficients(new double[]{dArr2[i6][j][k], dArr2[ip1][j][k], dArr2[i6][jp1][k], dArr2[ip1][jp1][k], dArr2[i6][j][kp1], dArr2[ip1][j][kp1], dArr2[i6][jp1][kp1], dArr2[ip1][jp1][kp1], dArr3[i6][j][k], dArr3[ip1][j][k], dArr3[i6][jp1][k], dArr3[ip1][jp1][k], dArr3[i6][j][kp1], dArr3[ip1][j][kp1], dArr3[i6][jp1][kp1], dArr3[ip1][jp1][kp1], dArr4[i6][j][k], dArr4[ip1][j][k], dArr4[i6][jp1][k], dArr4[ip1][jp1][k], dArr4[i6][j][kp1], dArr4[ip1][j][kp1], dArr4[i6][jp1][kp1], dArr4[ip1][jp1][kp1], dArr5[i6][j][k], dArr5[ip1][j][k], dArr5[i6][jp1][k], dArr5[ip1][jp1][k], dArr5[i6][j][kp1], dArr5[ip1][j][kp1], dArr5[i6][jp1][kp1], dArr5[ip1][jp1][kp1], dArr6[i6][j][k], dArr6[ip1][j][k], dArr6[i6][jp1][k], dArr6[ip1][jp1][k], dArr6[i6][j][kp1], dArr6[ip1][j][kp1], dArr6[i6][jp1][kp1], dArr6[ip1][jp1][kp1], dArr7[i6][j][k], dArr7[ip1][j][k], dArr7[i6][jp1][k], dArr7[ip1][jp1][k], dArr7[i6][j][kp1], dArr7[ip1][j][kp1], dArr7[i6][jp1][kp1], dArr7[ip1][jp1][kp1], dArr8[i6][j][k], dArr8[ip1][j][k], dArr8[i6][jp1][k], dArr8[ip1][jp1][k], dArr8[i6][j][kp1], dArr8[ip1][j][kp1], dArr8[i6][jp1][kp1], dArr8[ip1][jp1][kp1], dArr9[i6][j][k], dArr9[ip1][j][k], dArr9[i6][jp1][k], dArr9[ip1][jp1][k], dArr9[i6][j][kp1], dArr9[ip1][j][kp1], dArr9[i6][jp1][kp1], dArr9[ip1][jp1][kp1]}));
                                    k++;
                                    lastK = lastK2;
                                    dArr2 = f;
                                    dArr3 = dFdX;
