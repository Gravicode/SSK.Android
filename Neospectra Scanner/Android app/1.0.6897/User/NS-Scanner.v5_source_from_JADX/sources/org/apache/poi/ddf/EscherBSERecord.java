...
public final class EscherBSERecord extends EscherRecord {
    ...
    public int fillFields(byte[] data, int offset, EscherRecordFactory recordFactory) {
        ...
        int i3 = bytesRemaining3 + 8 + 36;
        if (this.field_12_blipRecord != null) {
            i2 = this.field_12_blipRecord.getRecordSize();
        }
        return i3 + i2;
    }
    ...
    public String toString() {
        ...
        sb.append(10);
        sb.append("  SUID: ");
        sb.append(this.field_3_uid == null ? "" : HexDump.toHex(this.field_3_uid));
        sb.append(10);
        sb.append("  Tag: ");
