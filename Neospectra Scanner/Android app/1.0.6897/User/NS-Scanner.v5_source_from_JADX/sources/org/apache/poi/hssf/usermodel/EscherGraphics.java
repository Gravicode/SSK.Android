...
public class EscherGraphics extends Graphics {
    ...
    public boolean drawImage(Image image, int i, int j, int k, int l, Color color, ImageObserver imageobserver) {
        ...
        return drawImage(image2, i, j, i + k, j + l, 0, 0, image2.getWidth(imageObserver), image2.getHeight(imageObserver), color, imageObserver);
    }

    public boolean drawImage(Image image, int i, int j, int k, int l, ImageObserver imageobserver) {
        Image image2 = image;
        ImageObserver imageObserver = imageobserver;
        return drawImage(image2, i, j, i + k, j + l, 0, 0, image2.getWidth(imageObserver), image2.getHeight(imageObserver), imageObserver);
    }
    ...
    public void drawString(String str, int x, int y) {
        ...
        if (str != null && !str.equals("")) {
            ...
            int y2 = (int) (((float) y) - ((((float) this.font.getSize()) / this.verticalPixelsPerPoint) + (this.verticalPixelsPerPoint * 2.0f)));
            ...
            s.applyFont((org.apache.poi.p009ss.usermodel.Font) matchFont(excelFont));
            textbox.setString(s);
        }
    }
    ...
    private HSSFFont matchFont(Font font2) {
        ...
        short s = 700;
        HSSFFont hssfFont = this.workbook.findFont(bold ? (short) 700 : 0, hssfColor.getIndex(), (short) (font2.getSize() * 20), font2.getName(), italic, false, 0, 0);
        if (hssfFont == null) {
