...
public final class SupBookRecord extends StandardRecord {
    ...
    public SupBookRecord(RecordInputStream in) {
        ...
        if (nextShort == 1025) {
            ...
            if (this.field_1_number_of_sheets != 1) {
                ...
                sb.append("Expected 0x0001 for number of sheets field in 'Add-In Functions' but got (");
            ...
            sb2.append("invalid EXTERNALBOOK code (");
            sb2.append(Integer.toHexString(nextShort));
            sb2.append(")");
    ...
    public void serialize(LittleEndianOutput out) {
        ...
        out.writeShort(this._isAddInFunctions != 0 ? 14849 : InputDeviceCompat.SOURCE_GAMEPAD);
    }
