...
public class TTest {
    public double pairedT(double[] sample1, double[] sample2) throws NullArgumentException, NoDataException, DimensionMismatchException, NumberIsTooSmallException {
        ...
        return mo19613t(meanDifference, 0.0d, StatUtils.varianceDifference(sample1, sample2, meanDifference), (double) sample1.length);
    }
    ...
    /* renamed from: t */
    public double mo19616t(double mu, double[] observed) throws NullArgumentException, NumberIsTooSmallException {
        checkSampleData(observed);
        return mo19613t(StatUtils.mean(observed), mu, StatUtils.variance(observed), (double) observed.length);
    }

    /* renamed from: t */
    public double mo19615t(double mu, StatisticalSummary sampleStats) throws NullArgumentException, NumberIsTooSmallException {
        checkSampleData(sampleStats);
        return mo19613t(sampleStats.getMean(), mu, sampleStats.getVariance(), (double) sampleStats.getN());
    }
    ...
    /* renamed from: t */
    public double mo19618t(double[] sample1, double[] sample2) throws NullArgumentException, NumberIsTooSmallException {
        checkSampleData(sample1);
        checkSampleData(sample2);
        return mo19614t(StatUtils.mean(sample1), StatUtils.mean(sample2), StatUtils.variance(sample1), StatUtils.variance(sample2), (double) sample1.length, (double) sample2.length);
    }

    /* renamed from: t */
    public double mo19617t(StatisticalSummary sampleStats1, StatisticalSummary sampleStats2) throws NullArgumentException, NumberIsTooSmallException {
        checkSampleData(sampleStats1);
        checkSampleData(sampleStats2);
        return mo19614t(sampleStats1.getMean(), sampleStats2.getMean(), sampleStats1.getVariance(), sampleStats2.getVariance(), (double) sampleStats1.getN(), (double) sampleStats2.getN());
    }
    ...
    /* renamed from: df */
    public double mo19602df(double v1, double v2, double n1, double n2) {
        return (((v1 / n1) + (v2 / n2)) * ((v1 / n1) + (v2 / n2))) / (((v1 * v1) / ((n1 * n1) * (n1 - 1.0d))) + ((v2 * v2) / ((n2 * n2) * (n2 - 1.0d))));
    }

    /* access modifiers changed from: protected */
    /* renamed from: t */
    public double mo19613t(double m, double mu, double v, double n) {
        return (m - mu) / FastMath.sqrt(v / n);
    }

    /* access modifiers changed from: protected */
    /* renamed from: t */
    public double mo19614t(double m1, double m2, double v1, double v2, double n1, double n2) {
    ...
    public double homoscedasticT(double m1, double m2, double v1, double v2, double n1, double n2) {
        return (m1 - m2) / FastMath.sqrt(((((n1 - 1.0d) * v1) + ((n2 - 1.0d) * v2)) / ((n1 + n2) - 2.0d)) * ((1.0d / n1) + (1.0d / n2)));
    }

    /* access modifiers changed from: protected */
    public double tTest(double m, double mu, double v, double n) throws MaxCountExceededException, MathIllegalArgumentException {
        return new TDistribution((RandomGenerator) null, n - 1.0d).cumulativeProbability(-FastMath.abs(mo19613t(m, mu, v, n))) * 2.0d;
    }
    ...
    public double tTest(double m1, double m2, double v1, double v2, double n1, double n2) throws MaxCountExceededException, NotStrictlyPositiveException {
        return new TDistribution((RandomGenerator) null, mo19602df(v1, v2, n1, n2)).cumulativeProbability(-FastMath.abs(mo19614t(m1, m2, v1, v2, n1, n2))) * 2.0d;
    }
    ...
    public double homoscedasticTTest(double m1, double m2, double v1, double v2, double n1, double n2) throws MaxCountExceededException, NotStrictlyPositiveException {
        return new TDistribution((RandomGenerator) null, (n1 + n2) - 2.0d).cumulativeProbability(-FastMath.abs(homoscedasticT(m1, m2, v1, v2, n1, n2))) * 2.0d;
    }
