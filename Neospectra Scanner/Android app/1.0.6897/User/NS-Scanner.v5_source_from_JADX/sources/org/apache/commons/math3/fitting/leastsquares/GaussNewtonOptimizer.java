...
public class GaussNewtonOptimizer implements LeastSquaresOptimizer {
        ...
        CHOLESKY {
            ...
            public RealVector solve(RealMatrix jacobian, RealVector residuals) {
                try {
                    ...
                    CholeskyDecomposition choleskyDecomposition = new CholeskyDecomposition((RealMatrix) normalEquation.getFirst(), GaussNewtonOptimizer.SINGULARITY_THRESHOLD, GaussNewtonOptimizer.SINGULARITY_THRESHOLD);
                    return choleskyDecomposition.getSolver().solve(jTr);
    ...
    public String toString() {
        ...
        sb.append("GaussNewtonOptimizer{decomposition=");
        sb.append(this.decomposition);
        sb.append('}');
        return sb.toString();
    }
