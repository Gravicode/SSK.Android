...
public final class MulRKRecord extends StandardRecord {
    ...
    private static final class RkRec {
        ...
        /* renamed from: rk */
        public final int f816rk;

        /* renamed from: xf */
        public final short f817xf;

        private RkRec(RecordInputStream in) {
            this.f817xf = in.readShort();
            this.f816rk = in.readInt();
        }
    ...
    public short getXFAt(int coffset) {
        return this.field_3_rks[coffset].f817xf;
    }

    public double getRKNumberAt(int coffset) {
        return RKUtil.decodeNumber(this.field_3_rks[coffset].f816rk);
    }
