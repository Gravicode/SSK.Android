...
/* renamed from: org.apache.poi.hssf.record.cf.FontFormatting */
    ...
    public String toString() {
        ...
        if (isFontStyleModified()) {
            ...
            if (getFontWeight() == 400) {
                ...
                sb.append("0x");
                sb.append(Integer.toHexString(getFontWeight()));
                str = sb.toString();
            }
            buffer.append(str);
            buffer.append("\n");
        ...
        sb2.append("0x");
        sb2.append(Integer.toHexString(getFontColorIndex()).toUpperCase());
