...
class DormandPrince853StepInterpolator extends RungeKuttaStepInterpolator {
    ...
    DormandPrince853StepInterpolator(DormandPrince853StepInterpolator interpolator) {
        ...
        this.f684v = new double[7][];
        for (int k2 = 0; k2 < this.f684v.length; k2++) {
            this.f684v[k2] = new double[dimension];
            System.arraycopy(interpolator.f684v[k2], 0, this.f684v[k2], 0, dimension);
        }
    ...
    public void computeInterpolatedStateAndDerivatives(double theta, double oneMinusThetaH) throws MaxCountExceededException {
        if (!this.vectorsInitialized) {
            ...
            if (this.f684v == null) {
                this.f684v = new double[7][];
                for (int k = 0; k < 7; k++) {
                    this.f684v[k] = new double[this.interpolatedState.length];
                }
            }
            finalizeStep();
            int i = 0;
            while (i < this.interpolatedState.length) {
                ...
                this.f684v[0][i] = (B_01 * yDot1) + (B_06 * yDot6) + (B_07 * yDot7) + (B_08 * yDot8) + (B_09 * yDot9) + (B_10 * yDot10) + (B_11 * yDot11) + (B_12 * yDot12);
                this.f684v[1][i] = yDot1 - this.f684v[0][i];
                this.f684v[2][i] = (this.f684v[0][i] - this.f684v[1][i]) - this.yDotK[12][i];
                for (int k2 = 0; k2 < f683D.length; k2++) {
                    this.f684v[k2 + 3][i] = (f683D[k2][0] * yDot1) + (f683D[k2][1] * yDot6) + (f683D[k2][2] * yDot7) + (f683D[k2][3] * yDot8) + (f683D[k2][4] * yDot9) + (f683D[k2][5] * yDot10) + (f683D[k2][6] * yDot11) + (f683D[k2][7] * yDot12) + (f683D[k2][8] * yDot13) + (f683D[k2][9] * yDot14) + (f683D[k2][10] * yDot15) + (f683D[k2][11] * yDot16);
                }
                i++;
                c = 7;
            }
        ...
        double dot2 = (2.0d - (theta * 3.0d)) * theta;
        double dot3 = (((twoTheta - 3.0d) * theta) + 1.0d) * twoTheta;
        double dot4 = ((((5.0d * theta) - 8.0d) * theta) + 3.0d) * theta2;
        double dot5 = ((theta * (((15.0d - (6.0d * theta)) * theta) - 0.375d)) + 3.0d) * theta2;
        double dot6 = theta2 * theta * ((theta * (((18.0d - (7.0d * theta)) * theta) - 0.28125d)) + 4.0d);
        if (this.previousState == null || theta > 0.5d) {
            for (int i2 = 0; i2 < this.interpolatedState.length; i2++) {
                this.interpolatedState[i2] = this.currentState[i2] - ((this.f684v[0][i2] - ((this.f684v[1][i2] + ((this.f684v[2][i2] + ((this.f684v[3][i2] + ((this.f684v[4][i2] + ((this.f684v[5][i2] + (this.f684v[6][i2] * theta)) * eta)) * theta)) * eta)) * theta)) * theta)) * oneMinusThetaH);
                this.interpolatedDerivatives[i2] = this.f684v[0][i2] + (this.f684v[1][i2] * dot1) + (this.f684v[2][i2] * dot2) + (this.f684v[3][i2] * dot3) + (this.f684v[4][i2] * dot4) + (this.f684v[5][i2] * dot5) + (this.f684v[6][i2] * dot6);
            }
            return;
        }
        for (int i3 = 0; i3 < this.interpolatedState.length; i3++) {
            this.interpolatedState[i3] = this.previousState[i3] + (this.f701h * theta * (this.f684v[0][i3] + ((this.f684v[1][i3] + ((this.f684v[2][i3] + ((this.f684v[3][i3] + ((this.f684v[4][i3] + ((this.f684v[5][i3] + (this.f684v[6][i3] * theta)) * eta)) * theta)) * eta)) * theta)) * eta)));
            this.interpolatedDerivatives[i3] = this.f684v[0][i3] + (this.f684v[1][i3] * dot1) + (this.f684v[2][i3] * dot2) + (this.f684v[3][i3] * dot3) + (this.f684v[4][i3] * dot4) + (this.f684v[5][i3] * dot5) + (this.f684v[6][i3] * dot6);
        }
    }
    ...
    public void doFinalize() throws MaxCountExceededException {
        ...
        if (this.currentState != null) {
            ...
            while (true) {
                ...
                yTmp[j] = this.currentState[j] + (this.f701h * ((this.yDotK[0][j] * K14_01) + (this.yDotK[5][j] * K14_06) + (this.yDotK[6][j] * K14_07) + (this.yDotK[7][j] * K14_08) + (this.yDotK[8][j] * K14_09) + (this.yDotK[9][j] * K14_10) + (this.yDotK[10][j] * K14_11) + (this.yDotK[11][j] * K14_12) + (this.yDotK[12][j] * K14_13)));
                j++;
            }
            this.integrator.computeDerivatives((this.f701h * C14) + pT, yTmp, this.yDotKLast[0]);
            int j2 = 0;
            while (j2 < this.currentState.length) {
                yTmp[j2] = this.currentState[j2] + (this.f701h * ((this.yDotK[0][j2] * K15_01) + (this.yDotK[5][j2] * K15_06) + (this.yDotK[6][j2] * K15_07) + (this.yDotK[7][j2] * K15_08) + (this.yDotK[8][j2] * K15_09) + (this.yDotK[c2][j2] * 0.1521609496625161d) + (this.yDotK[c][j2] * K15_11) + (this.yDotK[11][j2] * K15_12) + (this.yDotK[12][j2] * K15_13) + (this.yDotKLast[0][j2] * K15_14)));
                j2++;
                c = 10;
                c2 = 9;
            }
            this.integrator.computeDerivatives((this.f701h * C15) + pT, yTmp, this.yDotKLast[1]);
            for (int j3 = 0; j3 < this.currentState.length; j3++) {
                yTmp[j3] = this.currentState[j3] + (this.f701h * ((this.yDotK[0][j3] * K16_01) + (this.yDotK[5][j3] * K16_06) + (this.yDotK[6][j3] * K16_07) + (this.yDotK[7][j3] * K16_08) + (this.yDotK[8][j3] * K16_09) + (this.yDotK[9][j3] * 0.1521609496625161d) + (this.yDotK[10][j3] * K16_11) + (this.yDotK[11][j3] * K16_12) + (this.yDotK[12][j3] * K16_13) + (this.yDotKLast[0][j3] * K16_14) + (this.yDotKLast[1][j3] * K16_15)));
            }
            this.integrator.computeDerivatives((this.f701h * C16) + pT, yTmp, this.yDotKLast[2]);
        }
    }
