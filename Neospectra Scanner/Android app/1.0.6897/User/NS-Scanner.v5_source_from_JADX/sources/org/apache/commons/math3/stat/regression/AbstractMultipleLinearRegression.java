...
public abstract class AbstractMultipleLinearRegression implements MultipleLinearRegression {
    ...
    public void newSampleData(double[] data, int nobs, int nvars) {
        if (data == null) {
            ...
            double[][] x = (double[][]) Array.newInstance(double.class, new int[]{nobs, cols});
            int pointer = 0;
            int i = 0;
            while (i < nobs) {
    ...
    public void newXSampleData(double[][] x) {
        if (x == null) {
            ...
            double[][] xAug = (double[][]) Array.newInstance(double.class, new int[]{x.length, nVars + 1});
