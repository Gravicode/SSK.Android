...
public class EscherBlipWMFRecord extends EscherBlipRecord {
    ...
    public int fillFields(byte[] data, int offset, EscherRecordFactory recordFactory) {
        ...
        System.arraycopy(data, pos + 0, this.field_1_secondaryUID, 0, 16);
        int size = 0 + 16;
        ...
        System.arraycopy(data, pos + size11, this.field_12_data, 0, bytesRemaining);
    ...
    public int serialize(int offset, byte[] data, EscherSerializationListener listener) {
        ...
        System.arraycopy(this.field_12_data, 0, data, pos12, this.field_12_data.length);
    ...
    public String toString() {
        ...
        sb.append(HexDump.toHex(this.field_1_secondaryUID));
        sb.append(nl);
        sb.append("  CacheOfSize: ");
        sb.append(this.field_2_cacheOfSize);
        sb.append(nl);
        sb.append("  BoundaryTop: ");
        sb.append(this.field_3_boundaryTop);
        sb.append(nl);
        sb.append("  BoundaryLeft: ");
        sb.append(this.field_4_boundaryLeft);
        sb.append(nl);
        sb.append("  BoundaryWidth: ");
        sb.append(this.field_5_boundaryWidth);
        sb.append(nl);
        sb.append("  BoundaryHeight: ");
        sb.append(this.field_6_boundaryHeight);
        sb.append(nl);
        sb.append("  X: ");
        sb.append(this.field_7_width);
        sb.append(nl);
        sb.append("  Y: ");
        sb.append(this.field_8_height);
        sb.append(nl);
        sb.append("  CacheOfSavedSize: ");
        sb.append(this.field_9_cacheOfSavedSize);
        sb.append(nl);
        sb.append("  CompressionFlag: ");
        sb.append(this.field_10_compressionFlag);
        sb.append(nl);
        sb.append("  Filter: ");
        sb.append(this.field_11_filter);
        sb.append(nl);
        sb.append("  Data:");
        sb.append(nl);
        sb.append(extraData);
