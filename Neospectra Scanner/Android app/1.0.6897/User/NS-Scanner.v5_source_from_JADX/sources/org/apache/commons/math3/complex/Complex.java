...
public class Complex implements FieldElement<Complex>, Serializable {
    ...
    /* renamed from: I */
    public static final Complex f537I = new Complex(0.0d, 1.0d);
    ...
    public Complex(double real2, double imaginary2) {
        ...
        boolean z = true;
        this.isNaN = Double.isNaN(real2) || Double.isNaN(imaginary2);
    ...
    public Complex acos() {
        ...
        return add(sqrt1z().multiply(f537I)).log().multiply(f537I.negate());
    }
    ...
    public Complex asin() {
        ...
        return sqrt1z().add(multiply(f537I)).log().multiply(f537I.negate());
    }
    ...
    public Complex atan() {
        ...
        return add(f537I).divide(f537I.subtract(this)).log().multiply(f537I.divide(createComplex(2.0d, 0.0d)));
    }
    ...
    public List<Complex> nthRoot(int n) throws NotPositiveException {
        ...
        if (this.isNaN) {
            ...
            double nthRootOfAbs = FastMath.pow(abs(), 1.0d / ((double) i));
            double slice = 6.283185307179586d / ((double) i);
            double innerPart = getArgument() / ((double) i);
            int k = 0;
            while (k < i) {
                result.add(createComplex(FastMath.cos(innerPart) * nthRootOfAbs, FastMath.sin(innerPart) * nthRootOfAbs));
                innerPart += slice;
                k++;
                i = n;
            }
