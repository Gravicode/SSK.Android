...
public final class TableRecord extends SharedValueRecordBase {
    ...
    public String toString() {
        ...
        buffer.append("\n");
        CellReference crRowInput = m66cr(this.field_7_rowInputRow, this.field_8_colInputRow);
        CellReference crColInput = m66cr(this.field_9_rowInputCol, this.field_10_colInputCol);
    ...
    /* renamed from: cr */
    private static CellReference m66cr(int rowIx, int colIxAndFlags) {
        int colIx = colIxAndFlags & 255;
        boolean isColAbs = false;
