...
public class OLSMultipleLinearRegression extends AbstractMultipleLinearRegression {
    ...
    /* renamed from: qr */
    private QRDecomposition f795qr;
    ...
    public void newSampleData(double[] data, int nobs, int nvars) {
        ...
        this.f795qr = new QRDecomposition(getX(), this.threshold);
    }

    public RealMatrix calculateHat() {
        RealMatrix Q = this.f795qr.getQ();
        int p = this.f795qr.getR().getColumnDimension();
    ...
    public RealVector calculateBeta() {
        return this.f795qr.getSolver().solve(getY());
    }

    /* access modifiers changed from: protected */
    public RealMatrix calculateBetaVariance() {
        int p = getX().getColumnDimension();
        RealMatrix Rinv = new LUDecomposition(this.f795qr.getR().getSubMatrix(0, p - 1, 0, p - 1)).getSolver().getInverse();
