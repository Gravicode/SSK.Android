...
public abstract class Property implements Child, POIFSViewable {
    ...
    public void setStorageClsid(ClassID clsidStorage) {
        ...
        if (clsidStorage == null) {
            Arrays.fill(this._raw_data, 80, 96, 0);
        } else {
    ...
    public Object[] getViewableArray() {
        ...
        sb2.append(this._property_type.get());
        StringBuilder sb3 = new StringBuilder();
        sb3.append("Node Color    = ");
        sb3.append(this._node_color.get());
        ...
        sb5.append("Time 2        = ");
        sb5.append(time2);
        return new Object[]{sb.toString(), sb2.toString(), sb3.toString(), sb4.toString(), sb5.toString()};
    }
