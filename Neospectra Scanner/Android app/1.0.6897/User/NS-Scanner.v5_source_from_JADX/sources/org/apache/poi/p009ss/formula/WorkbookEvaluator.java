...
/* renamed from: org.apache.poi.ss.formula.WorkbookEvaluator */
public final class WorkbookEvaluator {
    ...
    /* access modifiers changed from: 0000 */
    public WorkbookEvaluator getOtherWorkbookEvaluator(String workbookName) throws WorkbookNotFoundException {
    ...
    private ValueEval evaluateAny(EvaluationCell srcCell, int sheetIndex, int rowIndex, int columnIndex, EvaluationTracker tracker) {
        ...
        boolean z = true;
        if (this._stabilityClassifier != null && this._stabilityClassifier.isCellFinal(i, i2, i3)) {
            z = false;
        }
        ...
        if (evaluationCell == null) {
            ...
            if (cce.getValue() != null) {
                ...
                OperationEvaluationContext ec = operationEvaluationContext;
                try {
        ...
        if (shouldCellDependencyBeRecorded) {
            evaluationTracker.acceptPlainValueDependency(this._workbookIx, i, i2, i3, result3);
        }
        return result3;
    }
    ...
    private NotImplementedException addExceptionInfo(NotImplementedException inner, int sheetIndex, int rowIndex, int columnIndex) {
        try {
            ...
            StringBuilder sb = new StringBuilder();
            sb.append("Error evaluating cell ");
            sb.append(cellReference.formatAsString());
            return new NotImplementedException(sb.toString(), inner);
        } catch (Exception e) {
            e.printStackTrace();
            return inner;
        }
    ...
    public ValueEval evaluateFormula(OperationEvaluationContext ec, Ptg[] ptgs) {
        ...
        while (i < iSize) {
            OperationPtg operationPtg = ptgs[i];
            if (operationPtg instanceof AttrPtg) {
                ...
                if (attrPtg.isOptimizedChoose()) {
                    ...
                    try {
                        ...
                        if (switchIndex >= 1) {
                            if (switchIndex <= nChoices) {
                                dist2 = jumpTable[switchIndex - 1];
                                dist = dist2;
                                i += countTokensToBeSkipped(ptgs, i, dist - ((nChoices * 2) + 2));
                            }
                        }
                        stack.push(ErrorEval.VALUE_INVALID);
                        dist2 = attrPtg.getChooseFuncOffset() + 4;
                        dist = dist2;
                    ...
                    try {
                        ...
                        int i2 = i + countTokensToBeSkipped(ptgs, i, attrPtg.getData());
                        i = i2 + countTokensToBeSkipped(ptgs, i2, ((AttrPtg) ptgs[i2]).getData() + 1);
                    }
            ...
            if (!(operationPtg instanceof ControlPtg) && !(operationPtg instanceof MemFuncPtg) && !(operationPtg instanceof MemAreaPtg) && !(operationPtg instanceof MemErrPtg)) {
                if (operationPtg instanceof OperationPtg) {
                    OperationPtg optg = operationPtg;
                    ...
                    opResult = getEvalForPtg(operationPtg, ec);
                }
                if (opResult == null) {
    ...
    private ValueEval getEvalForPtg(Ptg ptg, OperationEvaluationContext ec) {
        if (ptg instanceof NamePtg) {
            ...
            StringBuilder sb = new StringBuilder();
            sb.append("Don't now how to evalate name '");
            ...
            if (ptg instanceof Ref3DPtg) {
                ...
                sb2.append("Unexpected ptg class (");
                sb2.append(ptg.getClass().getName());
                sb2.append(")");
