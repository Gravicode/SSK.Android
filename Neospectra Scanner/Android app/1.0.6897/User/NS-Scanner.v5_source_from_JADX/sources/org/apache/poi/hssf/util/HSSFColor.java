...
import org.apache.poi.p009ss.usermodel.Color;
    ...
    private static Hashtable createColorsByIndexMap() {
        ...
        for (HSSFColor color : colors) {
            ...
            if (result.containsKey(index1)) {
                ...
                sb.append("Dup color index (");
                sb.append(index1);
                sb.append(") for colors (");
                sb.append(prevColor.getClass().getName());
                sb.append("),(");
                sb.append(color.getClass().getName());
                sb.append(")");
    ...
    private static Hashtable createColorsByHexStringMap() {
        ...
        for (HSSFColor color : colors) {
            ...
            if (result.containsKey(hexString)) {
                ...
                StringBuilder sb = new StringBuilder();
                sb.append("Dup color hexString (");
                sb.append(hexString);
                sb.append(") for color (");
                sb.append(color.getClass().getName());
                sb.append(") - ");
                sb.append(" already taken by (");
                sb.append(other.getClass().getName());
                sb.append(")");
                throw new RuntimeException(sb.toString());
            }
