...
public class HypergeometricDistribution extends AbstractIntegerDistribution {
    ...
    public double logProbability(int x) {
        ...
        if (i < domain[0] || i > domain[1]) {
            ...
            double p1 = SaddlePointExpansion.logBinomialProbability(i, this.numberOfSuccesses, p, q);
            double d = p;
            double d2 = q;
            double p2 = SaddlePointExpansion.logBinomialProbability(this.sampleSize - i, this.populationSize - this.numberOfSuccesses, d, d2);
            ret = (p1 + p2) - SaddlePointExpansion.logBinomialProbability(this.sampleSize, this.populationSize, d, d2);
        }
        return ret;
    }
