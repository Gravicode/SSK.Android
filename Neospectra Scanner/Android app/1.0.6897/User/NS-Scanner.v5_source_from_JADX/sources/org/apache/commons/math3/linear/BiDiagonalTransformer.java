...
class BiDiagonalTransformer {
    ...
    public RealMatrix getU() {
        ...
        if (this.cachedU == null) {
            ...
            double[][] ua = (double[][]) Array.newInstance(double.class, new int[]{m, m});
            int k = m - 1;
            while (true) {
                d = 1.0d;
                if (k < p) {
    ...
    public RealMatrix getB() {
        if (this.cachedB == null) {
            int m = this.householderVectors.length;
            int n = this.householderVectors[0].length;
            double[][] ba = (double[][]) Array.newInstance(double.class, new int[]{m, n});
    ...
    public RealMatrix getV() {
        ...
        if (this.cachedV == null) {
            ...
            double[][] va = (double[][]) Array.newInstance(double.class, new int[]{n, n});
            int k = n - 1;
            while (true) {
                d = 1.0d;
                if (k < p) {
