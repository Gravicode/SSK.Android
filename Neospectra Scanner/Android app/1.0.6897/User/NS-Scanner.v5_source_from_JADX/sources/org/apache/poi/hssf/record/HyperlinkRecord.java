...
public final class HyperlinkRecord extends StandardRecord {
    ...
    static final class GUID {
        ...
        public static GUID parse(String rep) {
            ...
            int d0 = (parseShort(cc, 4) << 0) + (parseShort(cc, 0) << 16);
            int d1 = parseShort(cc, 9);
            int d2 = parseShort(cc, 14);
            for (int i = 23; i > 19; i--) {
                cc[i] = cc[i - 1];
            }
            GUID guid = new GUID(d0, d1, d2, parseLELong(cc, 20));
            return guid;
        }
    ...
    public HyperlinkRecord(RecordInputStream in) {
        ...
        if (streamVersion != 2) {
            StringBuilder sb = new StringBuilder();
            sb.append("Stream Version must be 0x2 but found ");
            ...
            if (URL_MONIKER.equals(this._moniker)) {
                ...
                if (in.readInt() > 0) {
                    ...
                    if (optFlags != 3) {
                        ...
                        sb2.append("Expected 0x3 but found ");
                        sb2.append(optFlags);
