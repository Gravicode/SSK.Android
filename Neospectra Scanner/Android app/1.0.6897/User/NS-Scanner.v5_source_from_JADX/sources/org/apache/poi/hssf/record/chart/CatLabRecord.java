...
public final class CatLabRecord extends StandardRecord {
    ...
    public void serialize(LittleEndianOutput out) {
        out.writeShort(this.f840rt);
        out.writeShort(this.grbitFrt);
        out.writeShort(this.wOffset);
        out.writeShort(this.f839at);
    ...
    public String toString() {
        ...
        buffer.append("    .rt      =");
        buffer.append(HexDump.shortToHex(this.f840rt));
        buffer.append(10);
        ...
        buffer.append(10);
        buffer.append("    .at      =");
        buffer.append(HexDump.shortToHex(this.f839at));
        buffer.append(10);
        buffer.append("    .grbit   =");
