...
public final class EscherProperties {
    ...
    private static Map<Short, EscherPropertyMetaData> initProps() {
        ...
        addProp(m, ShapeTypes.CLOUD_CALLOUT, "protection.lockaspectratio");
        addProp(m, ShapeTypes.CLOUD, "protection.lockposition");
        addProp(m, ShapeTypes.RIBBON, "protection.lockagainstselect");
        addProp(m, ShapeTypes.RIBBON_2, "protection.lockcropping");
        addProp(m, ShapeTypes.ELLIPSE_RIBBON, "protection.lockvertices");
        ...
        addProp(m, ShapeTypes.VERTICAL_SCROLL, "protection.lockagainstgrouping", 1);
        ...
        addProp(m, 191, "text.sizetexttofitshape", 1);
        ...
        addProp(m, 324, "geometry.shapepath", 3);
        addProp(m, 325, "geometry.vertices", 5);
        addProp(m, 326, "geometry.segmentinfo", 5);
        ...
        addProp(m, 383, "geometry.fillok", 1);
        addProp(m, 384, "fill.filltype");
        addProp(m, 385, "fill.fillcolor", 2);
        addProp(m, 386, "fill.fillopacity");
        addProp(m, 387, "fill.fillbackcolor", 2);
        ...
        addProp(m, 407, "fill.shadecolors", 5);
        ...
        addProp(m, 447, "fill.nofillhittest", 1);
        addProp(m, 448, "linestyle.color", 2);
        addProp(m, 449, "linestyle.opacity");
        addProp(m, 450, "linestyle.backcolor", 2);
        ...
        addProp(m, 463, "linestyle.linedashstyle", 5);
        ...
        addProp(m, FrameMetricsAggregator.EVERY_DURATION, "linestyle.nolinedrawdash", 1);
        addProp(m, 512, "shadowstyle.type");
        addProp(m, InputDeviceCompat.SOURCE_DPAD, "shadowstyle.color", 2);
        addProp(m, 514, "shadowstyle.highlight");
        addProp(m, 515, "shadowstyle.crmod");
        addProp(m, 516, "shadowstyle.opacity");
        addProp(m, RxBleConnection.GATT_MTU_MAXIMUM, "shadowstyle.offsetx");
        ...
        addProp(m, 899, "groupshape.wrappolygonvertices", 5);
        ...
        addProp(m, 959, "groupshape.print", 1);
        return m;
    }
