...
public final class EscherGraphics2d extends Graphics2D {
    ...
    public void draw(Shape shape) {
        if (shape instanceof Line2D) {
            ...
            if (this._stroke != null && (this._stroke instanceof BasicStroke)) {
                width = ((int) this._stroke.getLineWidth()) * HSSFShape.LINEWIDTH_ONE_PT;
            }
    ...
    public void drawArc(int x, int y, int width, int height, int startAngle, int arcAngle) {
        Float floatR = new Float((float) x, (float) y, (float) width, (float) height, (float) startAngle, (float) arcAngle, 0);
        draw(floatR);
    }
    ...
    public void drawImage(BufferedImage bufferedimage, BufferedImageOp op, int x, int y) {
        ...
        AffineTransform affineTransform = new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, (float) x, (float) y);
    ...
    public void drawRoundRect(int i, int j, int k, int l, int i1, int j1) {
        RoundRectangle2D.Float floatR = new RoundRectangle2D.Float((float) i, (float) j, (float) k, (float) l, (float) i1, (float) j1);
        draw(floatR);
    }
    ...
    public void fillArc(int i, int j, int k, int l, int i1, int j1) {
        Float floatR = new Float((float) i, (float) j, (float) k, (float) l, (float) i1, (float) j1, 2);
        fill(floatR);
    }
    ...
    public void fillRoundRect(int x, int y, int width, int height, int arcWidth, int arcHeight) {
        RoundRectangle2D.Float floatR = new RoundRectangle2D.Float((float) x, (float) y, (float) width, (float) height, (float) arcWidth, (float) arcHeight);
        fill(floatR);
    }
