...
public enum FilterType {
    TRIGGER_ONLY_DECREASING_EVENTS {
        ...
        public Transformer selectTransformer(Transformer previous, double g, boolean forward) {
            if (forward) {
                switch (C10043.$SwitchMap$org$apache$commons$math3$ode$events$Transformer[previous.ordinal()]) {
                    case 1:
                        if (g > 0.0d) {
    ...
    static /* synthetic */ class C10043 {
        ...
        static {
            $SwitchMap$org$apache$commons$math3$ode$events$Transformer = new int[Transformer.values().length];
            try {
