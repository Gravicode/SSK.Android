...
public class FastFourierTransformer implements Serializable {
    ...
    private static class MultiDimensionalComplexMatrix implements Cloneable {
        ...
        MultiDimensionalComplexMatrix(Object multiDimensionalComplexArray2) {
            ...
            for (Object lastDimension = multiDimensionalComplexArray2; lastDimension instanceof Object[]; lastDimension = lastDimension[0]) {
                numOfDimensions++;
            }
            ...
            while (lastDimension2 instanceof Object[]) {
                ...
                int numOfDimensions3 = numOfDimensions2 + 1;
                this.dimensionSize[numOfDimensions2] = array.length;
                lastDimension2 = array[0];
                numOfDimensions2 = numOfDimensions3;
            }
        }
        ...
        private void clone(MultiDimensionalComplexMatrix mdcm) {
            ...
            int size = 1;
            for (int i : this.dimensionSize) {
                size *= i;
            }
            int[][] vectorList = (int[][]) Array.newInstance(int.class, new int[]{size, this.dimensionSize.length});
    ...
    private static void normalizeTransformedData(double[][] dataRI, DftNormalization normalization2, TransformType type) {
        ...
        switch (normalization2) {
            ...
            case UNITARY:
                ...
                while (i < n) {
                    dataR[i] = dataR[i] * scaleFactor2;
                    dataI[i] = dataI[i] * scaleFactor2;
                    i++;
                }
                return;
            default:
    ...
    private void mdfft(MultiDimensionalComplexMatrix mdcm, TransformType type, int d, int[] subVector) {
        ...
        if (subVector.length == dimensionSize.length) {
            ...
            while (true) {
                int i4 = i;
                if (i4 < dimensionSize[subVector.length]) {
