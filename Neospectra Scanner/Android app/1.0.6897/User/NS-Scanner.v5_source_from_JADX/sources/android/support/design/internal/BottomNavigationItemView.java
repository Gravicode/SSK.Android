...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int inactiveLabelSize = res.getDimensionPixelSize(C1099R.dimen.design_bottom_navigation_text_size);
        int activeLabelSize = res.getDimensionPixelSize(C1099R.dimen.design_bottom_navigation_active_text_size);
        this.mDefaultMargin = res.getDimensionPixelSize(C1099R.dimen.design_bottom_navigation_margin);
        ...
        LayoutInflater.from(context).inflate(C1099R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C1099R.C1100drawable.design_bottom_navigation_item_background);
        this.mIcon = (ImageView) findViewById(C1099R.C1101id.icon);
        this.mSmallLabel = (TextView) findViewById(C1099R.C1101id.smallLabel);
        this.mLargeLabel = (TextView) findViewById(C1099R.C1101id.largeLabel);
    }
