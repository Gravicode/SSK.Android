...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C1123R.C1125id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C1123R.C1125id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C1123R.C1125id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C1123R.C1125id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C1123R.styleable.ActionBar, C1123R.attr.actionBarStyle, 0);
        if (a.getBoolean(C1123R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C1123R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C1123R.attr.actionBarWidgetTheme, outValue, true);
