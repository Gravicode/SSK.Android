...
public class ViewDragHelper {
    ...
    public boolean canScroll(@android.support.annotation.NonNull android.view.View r17, boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x007f:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p001v4.widget.ViewDragHelper.canScroll(android.view.View, boolean, int, int, int, int):boolean");
    }
