...
import android.support.compat.C1088R;
...
public class NotificationCompat {
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            ...
            RemoteViews remoteViews = applyStandardTemplate(true, C1088R.layout.notification_template_custom_big, false);
            remoteViews.removeAllViews(C1088R.C1090id.actions);
            ...
            if (showActions && this.mBuilder.mActions != null) {
                ...
                if (numActions > 0) {
                    ...
                    for (int i = 0; i < numActions; i++) {
                        remoteViews.addView(C1088R.C1090id.actions, generateActionButton((Action) this.mBuilder.mActions.get(i)));
                    }
                }
            }
            if (!actionsVisible) {
            ...
            remoteViews.setViewVisibility(C1088R.C1090id.actions, actionVisibility);
            remoteViews.setViewVisibility(C1088R.C1090id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), tombstone ? C1088R.layout.notification_action_tombstone : C1088R.layout.notification_action);
            button.setImageViewBitmap(C1088R.C1090id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C1088R.color.notification_action_color_filter)));
            button.setTextViewText(C1088R.C1090id.action_text, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(C1088R.C1090id.action_container, action.actionIntent);
            }
            if (VERSION.SDK_INT >= 15) {
                button.setContentDescription(C1088R.C1090id.action_container, action.title);
            }
            return button;
        }
    }
    ...
    public static abstract class Style {
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r20, int r21, boolean r22) {
            ...
            L_0x0028:
                ...
                int r6 = android.support.compat.C1088R.C1090id.notification_background
                java.lang.String r9 = "setBackgroundResource"
                int r10 = android.support.compat.C1088R.C1089drawable.notification_bg_low
                r2.setInt(r6, r9, r10)
                int r6 = android.support.compat.C1088R.C1090id.icon
                java.lang.String r9 = "setBackgroundResource"
                int r10 = android.support.compat.C1088R.C1089drawable.notification_template_icon_low_bg
                r2.setInt(r6, r9, r10)
                goto L_0x005c
            L_0x004a:
                int r6 = android.support.compat.C1088R.C1090id.notification_background
                java.lang.String r9 = "setBackgroundResource"
                int r10 = android.support.compat.C1088R.C1089drawable.notification_bg
                r2.setInt(r6, r9, r10)
                int r6 = android.support.compat.C1088R.C1090id.icon
                java.lang.String r9 = "setBackgroundResource"
                int r10 = android.support.compat.C1088R.C1089drawable.notification_template_icon_bg
                r2.setInt(r6, r9, r10)
            L_0x005c:
                android.support.v4.app.NotificationCompat$Builder r6 = r0.mBuilder
            ...
            L_0x007c:
                ...
                int r6 = android.support.compat.C1088R.dimen.notification_right_icon_size
                int r6 = r1.getDimensionPixelSize(r6)
                int r9 = android.support.compat.C1088R.dimen.notification_small_icon_background_padding
                ...
                int r11 = android.support.compat.C1088R.C1090id.right_icon
            ...
            L_0x00b0:
                ...
                r2.setImageViewBitmap(r11, r7)
            L_0x00bf:
                int r7 = android.support.compat.C1088R.C1090id.right_icon
            ...
            L_0x00c5:
                ...
                int r6 = android.support.compat.C1088R.dimen.notification_large_icon_width
                int r6 = r1.getDimensionPixelSize(r6)
                int r7 = android.support.compat.C1088R.dimen.notification_big_circle_margin
                int r7 = r1.getDimensionPixelSize(r7)
                int r6 = r6 - r7
                int r7 = android.support.compat.C1088R.dimen.notification_small_icon_size_as_large
                int r7 = r1.getDimensionPixelSize(r7)
                android.support.v4.app.NotificationCompat$Builder r9 = r0.mBuilder
                ...
                int r11 = android.support.compat.C1088R.C1090id.icon
            ...
            L_0x0110:
                ...
                int r6 = android.support.compat.C1088R.C1090id.title
                android.support.v4.app.NotificationCompat$Builder r7 = r0.mBuilder
            ...
            L_0x011f:
                ...
                int r6 = android.support.compat.C1088R.C1090id.text
                android.support.v4.app.NotificationCompat$Builder r7 = r0.mBuilder
            ...
            L_0x013c:
                ...
                int r7 = android.support.compat.C1088R.C1090id.info
            ...
            L_0x0155:
                ...
                int r7 = android.support.compat.C1088R.integer.status_bar_notification_info_maxnum
                int r7 = r1.getInteger(r7)
                android.support.v4.app.NotificationCompat$Builder r8 = r0.mBuilder
                int r8 = r8.mNumber
                if (r8 <= r7) goto L_0x0173
                int r8 = android.support.compat.C1088R.C1090id.info
                int r9 = android.support.compat.C1088R.string.status_bar_notification_info_overflow
                java.lang.String r9 = r1.getString(r9)
                r2.setTextViewText(r8, r9)
                goto L_0x0185
            L_0x0173:
                java.text.NumberFormat r8 = java.text.NumberFormat.getIntegerInstance()
                int r9 = android.support.compat.C1088R.C1090id.info
                android.support.v4.app.NotificationCompat$Builder r11 = r0.mBuilder
                int r11 = r11.mNumber
                long r10 = (long) r11
            ...
            L_0x0195:
                ...
                int r6 = android.support.compat.C1088R.C1090id.text2
                android.support.v4.app.NotificationCompat$Builder r7 = r0.mBuilder
                java.lang.CharSequence r7 = r7.mContentText
                r2.setTextViewText(r6, r7)
                int r6 = android.support.compat.C1088R.C1090id.text2
            ...
            L_0x01ce:
                ...
                int r5 = android.support.compat.C1088R.dimen.notification_subtext_size
                int r5 = r1.getDimensionPixelSize(r5)
                float r5 = (float) r5
                int r6 = android.support.compat.C1088R.C1090id.text
                r2.setTextViewTextSize(r6, r12, r5)
            L_0x01e4:
                int r6 = android.support.compat.C1088R.C1090id.line1
                r7 = 0
                r8 = 0
                r9 = 0
                r15 = 0
            ...
            L_0x01f4:
                ...
                int r5 = android.support.compat.C1088R.C1090id.chronometer
                ...
                goto L_0x0244
            L_0x0232:
                int r5 = android.support.compat.C1088R.C1090id.time
                r2.setViewVisibility(r5, r12)
                int r5 = android.support.compat.C1088R.C1090id.time
            ...
            L_0x0244:
                r3 = 1
            L_0x0245:
                int r5 = android.support.compat.C1088R.C1090id.right_side
            ...
            L_0x024d:
                ...
                int r5 = android.support.compat.C1088R.C1090id.line3
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            Bitmap coloredBitmap = createColoredBitmap(C1088R.C1089drawable.notification_icon_background, color == 0 ? 0 : color, size);
        ...
        public void buildIntoRemoteViews(RemoteViews outerView, RemoteViews innerView) {
            ...
            outerView.removeAllViews(C1088R.C1090id.notification_main_column);
            outerView.addView(C1088R.C1090id.notification_main_column, innerView.clone());
            outerView.setViewVisibility(C1088R.C1090id.notification_main_column, 0);
            if (VERSION.SDK_INT >= 21) {
                outerView.setViewPadding(C1088R.C1090id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews outerView) {
            outerView.setViewVisibility(C1088R.C1090id.title, 8);
            outerView.setViewVisibility(C1088R.C1090id.text2, 8);
            outerView.setViewVisibility(C1088R.C1090id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            float largeFactor = (constrain(resources.getConfiguration().fontScale, 1.0f, 1.3f) - 1.0f) / 0.29999995f;
            return Math.round(((1.0f - largeFactor) * ((float) resources.getDimensionPixelSize(C1088R.dimen.notification_top_pad))) + (((float) resources.getDimensionPixelSize(C1088R.dimen.notification_top_pad_large_text)) * largeFactor));
        }
    ...
    static Action getActionCompatFromAction(android.app.Notification.Action action) {
        ...
        Action action2 = new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputs, null, z);
        return action2;
    }
