...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C1123R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C1123R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C1123R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C1123R.styleable.ActionBar_height, -1);
        if (getId() == C1123R.C1125id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C1123R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
        boolean z = false;
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C1123R.C1125id.action_bar);
        this.mContextView = findViewById(C1123R.C1125id.action_context_bar);
    }
