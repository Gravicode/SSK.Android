...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    public static class Behavior extends android.support.design.widget.CoordinatorLayout.Behavior<FloatingActionButton> {
        ...
        public Behavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C1099R.styleable.FloatingActionButton_Behavior_Layout);
            this.mAutoHideEnabled = a.getBoolean(C1099R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, true);
            a.recycle();
        }
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C1099R.styleable.FloatingActionButton, defStyleAttr, C1099R.style.Widget_Design_FloatingActionButton);
        this.mBackgroundTint = a.getColorStateList(C1099R.styleable.FloatingActionButton_backgroundTint);
        this.mBackgroundTintMode = ViewUtils.parseTintMode(a.getInt(C1099R.styleable.FloatingActionButton_backgroundTintMode, -1), null);
        this.mRippleColor = a.getColor(C1099R.styleable.FloatingActionButton_rippleColor, 0);
        this.mSize = a.getInt(C1099R.styleable.FloatingActionButton_fabSize, -1);
        this.mCustomSize = a.getDimensionPixelSize(C1099R.styleable.FloatingActionButton_fabCustomSize, 0);
        this.mBorderWidth = a.getDimensionPixelSize(C1099R.styleable.FloatingActionButton_borderWidth, 0);
        float elevation = a.getDimension(C1099R.styleable.FloatingActionButton_elevation, 0.0f);
        float pressedTranslationZ = a.getDimension(C1099R.styleable.FloatingActionButton_pressedTranslationZ, 0.0f);
        this.mCompatPadding = a.getBoolean(C1099R.styleable.FloatingActionButton_useCompatPadding, false);
        a.recycle();
        this.mImageHelper = new AppCompatImageHelper(this);
        this.mImageHelper.loadFromAttributes(attrs, defStyleAttr);
        this.mMaxImageSize = (int) getResources().getDimension(C1099R.dimen.design_fab_image_size);
    ...
    private int getSizeDimension(int size) {
        ...
        if (size == -1) {
            ...
            return res.getDimensionPixelSize(C1099R.dimen.design_fab_size_normal);
        } else {
            return res.getDimensionPixelSize(C1099R.dimen.design_fab_size_mini);
        }
    }
