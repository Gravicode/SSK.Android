    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i3 = 0; i3 < count; i3++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C1123R.C1125id.topPanel) {
                    topPanel = child;
                } else if (id == C1123R.C1125id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C1123R.C1125id.contentPanel && id != C1123R.C1125id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
        ...
        if (middlePanel == null || remainingHeight <= 0) {
            ...
            middlePanel.measure(i, MeasureSpec.makeMeasureSpec(middleHeight + heightToGive2, heightMode));
