...
class ItemTouchUIUtilImpl {
    ...
    static class Api21Impl extends BaseImpl {
        ...
        public void onDraw(Canvas c, RecyclerView recyclerView, View view, float dX, float dY, int actionState, boolean isCurrentlyActive) {
            if (isCurrentlyActive && view.getTag(C1129R.C1131id.item_touch_helper_previous_elevation) == null) {
                Object originalElevation = Float.valueOf(ViewCompat.getElevation(view));
                ViewCompat.setElevation(view, findMaxElevation(recyclerView, view) + 1.0f);
                view.setTag(C1129R.C1131id.item_touch_helper_previous_elevation, originalElevation);
            }
        ...
        public void clearView(View view) {
            Object tag = view.getTag(C1129R.C1131id.item_touch_helper_previous_elevation);
            if (tag != null && (tag instanceof Float)) {
                ViewCompat.setElevation(view, ((Float) tag).floatValue());
            }
            view.setTag(C1129R.C1131id.item_touch_helper_previous_elevation, null);
