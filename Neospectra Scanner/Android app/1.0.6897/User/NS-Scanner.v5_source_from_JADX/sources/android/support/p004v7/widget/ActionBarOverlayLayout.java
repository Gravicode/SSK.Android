...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = {C1123R.attr.actionBarSize, 16842841};
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C1123R.C1125id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C1123R.C1125id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C1123R.C1125id.action_bar));
        }
    }
