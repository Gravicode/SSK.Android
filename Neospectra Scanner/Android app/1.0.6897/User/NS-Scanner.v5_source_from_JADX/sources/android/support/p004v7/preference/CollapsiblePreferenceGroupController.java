...
final class CollapsiblePreferenceGroupController implements PreferenceInstanceStateCallback {
    ...
    static class ExpandButton extends Preference {
        ...
        private void initLayout() {
            setLayoutResource(C1126R.layout.expand_button);
            setIcon(C1126R.C1127drawable.ic_arrow_down_24dp);
            setTitle(C1126R.string.expand_button_title);
            setOrder(999);
        }
                ...
                if (!(preference instanceof PreferenceGroup) && preference.isVisible()) {
                    ...
                    if (!TextUtils.isEmpty(title)) {
                        if (summary == null) {
                            ...
                            summary = getContext().getString(C1126R.string.summary_collapsed_preference_list, new Object[]{summary, title});
                        }
                    }
                }
            }
