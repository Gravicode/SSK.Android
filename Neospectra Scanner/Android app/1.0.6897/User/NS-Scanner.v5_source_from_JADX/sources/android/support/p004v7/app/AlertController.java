...
class AlertController {
    ...
    public static class AlertParams {
        ...
        private void createListView(final android.support.p004v7.app.AlertController r12) {
            /*
                r11 = this;
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C1123R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C1123R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C1123R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C1123R.attr.alertDialogCenterButtons, outValue, true);
        if (outValue.data != 0) {
            return true;
        }
        return false;
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C1123R.styleable.AlertDialog, C1123R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C1123R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C1123R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C1123R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C1123R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C1123R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C1123R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C1123R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = a.getDimensionPixelSize(C1123R.styleable.AlertDialog_buttonIconDimen, 0);
        a.recycle();
    ...
    private void setupView() {
        /*
            ...
            int r2 = android.support.p004v7.appcompat.C1123R.C1125id.parentPanel
            android.view.View r1 = r1.findViewById(r2)
            int r2 = android.support.p004v7.appcompat.C1123R.C1125id.topPanel
            android.view.View r2 = r1.findViewById(r2)
            int r3 = android.support.p004v7.appcompat.C1123R.C1125id.contentPanel
            android.view.View r3 = r1.findViewById(r3)
            int r4 = android.support.p004v7.appcompat.C1123R.C1125id.buttonPanel
            android.view.View r4 = r1.findViewById(r4)
            int r5 = android.support.p004v7.appcompat.C1123R.C1125id.customPanel
            android.view.View r5 = r1.findViewById(r5)
            android.view.ViewGroup r5 = (android.view.ViewGroup) r5
            r0.setupCustomContent(r5)
            int r6 = android.support.p004v7.appcompat.C1123R.C1125id.topPanel
            android.view.View r6 = r5.findViewById(r6)
            int r7 = android.support.p004v7.appcompat.C1123R.C1125id.contentPanel
            android.view.View r7 = r5.findViewById(r7)
            int r8 = android.support.p004v7.appcompat.C1123R.C1125id.buttonPanel
        ...
        L_0x0071:
            ...
            int r14 = android.support.p004v7.appcompat.C1123R.C1125id.textSpacerNoButtons
        ...
        L_0x009b:
            int r14 = android.support.p004v7.appcompat.C1123R.C1125id.titleDividerNoCustom
        ...
        L_0x00a8:
            ...
            int r1 = android.support.p004v7.appcompat.C1123R.C1125id.textSpacerNoTitle
        ...
        L_0x00b8:
            ...
            boolean r1 = r1 instanceof android.support.p004v7.app.AlertController.RecycleListView
            if (r1 == 0) goto L_0x00c5
            android.widget.ListView r1 = r0.mListView
            android.support.v7.app.AlertController$RecycleListView r1 = (android.support.p004v7.app.AlertController.RecycleListView) r1
        ...
        L_0x0101:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.app.AlertController.setupView():void");
    }

    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C1123R.C1125id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C1123R.C1125id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C1123R.C1125id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C1123R.C1125id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C1123R.C1125id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C1123R.C1125id.scrollView);
