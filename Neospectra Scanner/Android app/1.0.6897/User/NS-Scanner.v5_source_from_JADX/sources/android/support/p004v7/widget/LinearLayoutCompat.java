...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            this.gravity = -1;
            TypedArray a = c.obtainStyledAttributes(attrs, C1123R.styleable.LinearLayoutCompat_Layout);
            this.weight = a.getFloat(C1123R.styleable.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.gravity = a.getInt(C1123R.styleable.LinearLayoutCompat_Layout_android_layout_gravity, -1);
            a.recycle();
        }
    ...
    public LinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C1123R.styleable.LinearLayoutCompat, defStyleAttr, 0);
        int index = a.getInt(C1123R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (index >= 0) {
            setOrientation(index);
        }
        int index2 = a.getInt(C1123R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (index2 >= 0) {
            setGravity(index2);
        }
        boolean baselineAligned = a.getBoolean(C1123R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!baselineAligned) {
            setBaselineAligned(baselineAligned);
        }
        this.mWeightSum = a.getFloat(C1123R.styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = a.getInt(C1123R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = a.getBoolean(C1123R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(a.getDrawable(C1123R.styleable.LinearLayoutCompat_divider));
        this.mShowDividers = a.getInt(C1123R.styleable.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = a.getDimensionPixelSize(C1123R.styleable.LinearLayoutCompat_dividerPadding, 0);
        a.recycle();
    }
    ...
    public void measureVertical(int r58, int r59) {
        ...
        L_0x0210:
            ...
            android.support.v7.widget.LinearLayoutCompat$LayoutParams r0 = (android.support.p004v7.widget.LinearLayoutCompat.LayoutParams) r0
            int r8 = r7.mTotalLength
            int r19 = r8 + r13
            r37 = r3
            int r3 = r0.topMargin
    ...
    public void layoutHorizontal(int r32, int r33, int r34, int r35) {
        /*
            r31 = this;
            r6 = r31
            boolean r9 = android.support.p004v7.widget.ViewUtils.isLayoutRtl(r31)
            ...
            int r3 = android.support.p001v4.view.ViewCompat.getLayoutDirection(r31)
            int r11 = android.support.p001v4.view.GravityCompat.getAbsoluteGravity(r4, r3)
            r17 = 2
            r12 = 1
