...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!context.getTheme().resolveAttribute(C1123R.attr.actionBarPopupTheme, tv, true) || tv.resourceId == 0) {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C1123R.styleable.ActionBar, C1123R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(C1123R.styleable.ActionBar_height, 0));
        a.recycle();
