...
public class FontsContractCompat {
    ...
    public static class FontInfo {
        ...
        @RestrictTo({Scope.LIBRARY_GROUP})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int ttcIndex, @IntRange(from = 1, mo190to = 1000) int weight, boolean italic, int resultCode) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x008d, code lost:
        sBackgroundThread.postAndReply(r2, new android.support.p001v4.provider.FontsContractCompat.C02353());
     */
    ...
    static FontInfo[] getFontFromProvider(Context context, FontRequest request, String authority, CancellationSignal cancellationSignal) {
        ...
        Uri uri = new Builder().scheme(Param.CONTENT).authority(str).build();
        Uri fileBaseUri = new Builder().scheme(Param.CONTENT).authority(str).appendPath("file").build();
        try {
