...
public class SeekBarPreference extends Preference {
    ...
    public SeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C1126R.styleable.SeekBarPreference, defStyleAttr, defStyleRes);
        this.mMin = a.getInt(C1126R.styleable.SeekBarPreference_min, 0);
        setMax(a.getInt(C1126R.styleable.SeekBarPreference_android_max, 100));
        setSeekBarIncrement(a.getInt(C1126R.styleable.SeekBarPreference_seekBarIncrement, 0));
        this.mAdjustable = a.getBoolean(C1126R.styleable.SeekBarPreference_adjustable, true);
        this.mShowSeekBarValue = a.getBoolean(C1126R.styleable.SeekBarPreference_showSeekBarValue, true);
        a.recycle();
    }
    ...
    public SeekBarPreference(Context context, AttributeSet attrs) {
        this(context, attrs, C1126R.attr.seekBarPreferenceStyle);
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder view) {
        ...
        this.mSeekBar = (SeekBar) view.findViewById(C1126R.C1128id.seekbar);
        this.mSeekBarValueTextView = (TextView) view.findViewById(C1126R.C1128id.seekbar_value);
