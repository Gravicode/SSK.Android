...
public final class MediaControllerCompat {
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public final void registerCallback(android.support.p001v4.media.session.MediaControllerCompat.Callback r5, android.os.Handler r6) {
            /*
                r4 = this;
                java.lang.Object r0 = r4.mControllerObj
                java.lang.Object r1 = r5.mCallbackObj
                android.support.p001v4.media.session.MediaControllerCompatApi21.registerCallback(r0, r1, r6)
        ...
        /* JADX WARNING: No exception handlers in catch block: Catch:{  } */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public final void unregisterCallback(android.support.p001v4.media.session.MediaControllerCompat.Callback r4) {
            /*
                r3 = this;
        ...
        public PlaybackInfo getPlaybackInfo() {
            ...
            PlaybackInfo playbackInfo = new PlaybackInfo(android.support.p001v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getPlaybackType(volumeInfoObj), android.support.p001v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getLegacyAudioStream(volumeInfoObj), android.support.p001v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getVolumeControl(volumeInfoObj), android.support.p001v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getMaxVolume(volumeInfoObj), android.support.p001v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getCurrentVolume(volumeInfoObj));
            return playbackInfo;
        }
    ...
    static class TransportControlsApi24 extends TransportControlsApi23 {
        ...
        public void prepareFromMediaId(String mediaId, Bundle extras) {
            android.support.p001v4.media.session.MediaControllerCompatApi24.TransportControls.prepareFromMediaId(this.mControlsObj, mediaId, extras);
        }

        public void prepareFromSearch(String query, Bundle extras) {
            android.support.p001v4.media.session.MediaControllerCompatApi24.TransportControls.prepareFromSearch(this.mControlsObj, query, extras);
        }

        public void prepareFromUri(Uri uri, Bundle extras) {
            android.support.p001v4.media.session.MediaControllerCompatApi24.TransportControls.prepareFromUri(this.mControlsObj, uri, extras);
        }
    }
