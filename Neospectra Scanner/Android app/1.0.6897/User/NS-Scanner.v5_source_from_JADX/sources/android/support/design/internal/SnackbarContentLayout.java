...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, C1099R.styleable.SnackbarLayout);
        this.mMaxWidth = a.getDimensionPixelSize(C1099R.styleable.SnackbarLayout_android_maxWidth, -1);
        this.mMaxInlineActionWidth = a.getDimensionPixelSize(C1099R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
        a.recycle();
    }
    ...
    public void onFinishInflate() {
        ...
        this.mMessageView = (TextView) findViewById(C1099R.C1101id.snackbar_text);
        this.mActionView = (Button) findViewById(C1099R.C1101id.snackbar_action);
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int multiLineVPadding = getResources().getDimensionPixelSize(C1099R.dimen.design_snackbar_padding_vertical_2lines);
        int singleLineVPadding = getResources().getDimensionPixelSize(C1099R.dimen.design_snackbar_padding_vertical);
