...
public class MultiSelectListPreference extends AbstractMultiSelectListPreference {
    ...
    public MultiSelectListPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mValues = new HashSet();
        TypedArray a = context.obtainStyledAttributes(attrs, C1126R.styleable.MultiSelectListPreference, defStyleAttr, defStyleRes);
        this.mEntries = TypedArrayUtils.getTextArray(a, C1126R.styleable.MultiSelectListPreference_entries, C1126R.styleable.MultiSelectListPreference_android_entries);
        this.mEntryValues = TypedArrayUtils.getTextArray(a, C1126R.styleable.MultiSelectListPreference_entryValues, C1126R.styleable.MultiSelectListPreference_android_entryValues);
        a.recycle();
    }
