...
public class Scene {
    ...
    public static Scene getSceneForLayout(@NonNull ViewGroup sceneRoot, @LayoutRes int layoutId, @NonNull Context context) {
        SparseArray sparseArray = (SparseArray) sceneRoot.getTag(C1114R.C1116id.transition_scene_layoutid_cache);
        if (sparseArray == null) {
            sparseArray = new SparseArray();
            sceneRoot.setTag(C1114R.C1116id.transition_scene_layoutid_cache, sparseArray);
        }
    ...
    static void setCurrentScene(View view, Scene scene) {
        view.setTag(C1114R.C1116id.transition_current_scene, scene);
    }

    static Scene getCurrentScene(View view) {
        return (Scene) view.getTag(C1114R.C1116id.transition_current_scene);
    }
