...
public class ConstraintAnchor {
    ...
    public boolean isVerticalAnchor() {
        int i = C00101.f25x1d400623[this.mType.ordinal()];
        if (i != 6) {
            switch (i) {
                case 1:
                case 2:
    ...
    public String toString() {
        ...
        if (this.mTarget != null) {
            ...
            sb2.append(this.mTarget.toString(visited));
            str = sb2.toString();
        } else {
            str = "";
        }
    ...
    public boolean isSnapCompatibleWith(ConstraintAnchor anchor) {
        ...
        switch (this.mType) {
            case LEFT:
                int i = C00101.f25x1d400623[anchor.getType().ordinal()];
                if (i == 3 || i == 6) {
                    return true;
                }
                return false;
            case RIGHT:
                int i2 = C00101.f25x1d400623[anchor.getType().ordinal()];
                if (i2 == 2 || i2 == 6) {
                    return true;
                }
                return false;
            case TOP:
                int i3 = C00101.f25x1d400623[anchor.getType().ordinal()];
                if (i3 == 5 || i3 == 7) {
                    return true;
                }
                return false;
            case BOTTOM:
                int i4 = C00101.f25x1d400623[anchor.getType().ordinal()];
                if (i4 == 4 || i4 == 7) {
                    return true;
                }
                return false;
