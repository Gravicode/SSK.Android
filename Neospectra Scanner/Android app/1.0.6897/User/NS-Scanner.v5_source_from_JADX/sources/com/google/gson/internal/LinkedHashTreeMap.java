...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public Node<K, V> find(K key, boolean create) {
        ...
        if (nearest != null) {
            ...
            while (true) {
                if (comparable != null) {
                    ...
                    i = comparator2.compare(k, nearest.key);
                }
                comparison = i;
                if (comparison == 0) {
                    return nearest;
        ...
        Node<K, V> header2 = this.header;
        if (nearest2 != null) {
            Node<K, V> header3 = header2;
            created = new Node<>(nearest2, k, hash, header3, header3.prev);
            if (comparison2 < 0) {
            ...
            created = new Node<>(nearest2, k, hash, header2, header2.prev);
