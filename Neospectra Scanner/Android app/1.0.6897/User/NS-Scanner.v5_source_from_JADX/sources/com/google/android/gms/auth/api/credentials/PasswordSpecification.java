    ...
    public static class zza {
        ...
        private static TreeSet<Character> zzn(String str, String str2) {
            ...
            for (char c : str.toCharArray()) {
                if (PasswordSpecification.zzc(c, 32, ShapeTypes.LEFT_RIGHT_RIBBON)) {
        ...
        public final PasswordSpecification zzaaw() {
            ...
            PasswordSpecification passwordSpecification = new PasswordSpecification(PasswordSpecification.zzb(this.zzegb), this.zzefw, this.zzefx, this.zzefy, this.zzefz);
