...
public final class zzcla<T extends Context & zzcle> {
    ...
    public final /* synthetic */ void zza(int i, zzchm zzchm, Intent intent) {
        if (((zzcle) this.zzdyu).callServiceStopSelfResult(i)) {
            zzchm.zzazj().zzj("Local AppMeasurementService processed last upload request. StartId", Integer.valueOf(i));
    ...
    /* access modifiers changed from: 0000 */
    public final /* synthetic */ void zza(zzchm zzchm, JobParameters jobParameters) {
        zzchm.zzazj().log("AppMeasurementJobService processed last upload request.");
