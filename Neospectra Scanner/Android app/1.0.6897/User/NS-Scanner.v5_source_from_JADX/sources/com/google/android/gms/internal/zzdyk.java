...
public final class zzdyk extends zzbfm {
    ...
    public zzdyk(String str, String str2, boolean z, String str3, String str4, zzdyq zzdyq, String str5, String str6, long j, long j2, boolean z2) {
        this.zzmgg = str;
        this.zzegs = str2;
        this.zzmgh = z;
        this.zzegt = str3;
        this.zzmdx = str4;
        this.zzmgi = zzdyq == null ? new zzdyq() : zzdyq.zza(zzdyq);
        this.zzeey = str5;
        this.zzimi = str6;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        zzbfp.zza(parcel, 7, (Parcelable) this.zzmgi, i, false);
