...
public final class zzcup {
    ...
    public final zzcup zzku(String str) {
        ...
        zzcup zzcup = new zzcup(this.zzjxi, this.zzjxj, str, this.zzjxl, this.zzjxm, this.zzjxn);
        return zzcup;
    }

    public final zzcup zzkv(String str) {
        zzcup zzcup = new zzcup(this.zzjxi, this.zzjxj, this.zzjxk, str, this.zzjxm, this.zzjxn);
        return zzcup;
    }
}
