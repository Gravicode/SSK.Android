...
public final class zzcih extends zzcjl {
    ...
    public static final AtomicLong zzjeo = new AtomicLong(Long.MIN_VALUE);
    ...
    /* access modifiers changed from: private */
    public final Object zzjel = new Object();
    /* access modifiers changed from: private */
    public final Semaphore zzjem = new Semaphore(2);
    /* access modifiers changed from: private */
    public volatile boolean zzjen;

    zzcih(zzcim zzcim) {
        super(zzcim);
    }

    private final void zza(zzcik<?> zzcik) {
        synchronized (this.zzjel) {
            this.zzjeh.add(zzcik);
            if (this.zzjef == null) {
