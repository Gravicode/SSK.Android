...
public final class zzdyi extends zzbfm {
    ...
    public zzdyi(String str, boolean z, String str2, boolean z2, zzdyw zzdyw) {
        this.zzmgd = str;
        this.mRegistered = z;
        this.zzmcu = str2;
        this.zzmge = z2;
        this.zzmgf = zzdyw == null ? zzdyw.zzbsb() : zzdyw.zza(zzdyw);
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        zzbfp.zza(parcel, 6, (Parcelable) this.zzmgf, i, false);
