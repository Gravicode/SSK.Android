...
final /* synthetic */ class zzn implements Runnable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x0066, code lost:
        ...
        r4.putBoolean("oneWay", r1.zzcje());
        r4.putString("pkg", r3.getPackageName());
        r4.putBundle("data", r1.zznzj);
        r5.setData(r4);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x00a5, code lost:
        r0.zzm(2, r1.getMessage());
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void run() {
        /*
            r8 = this;
            com.google.firebase.iid.zzk r0 = r8.zznzg
        L_0x0002:
            monitor-enter(r0)
            ...
            return
        L_0x000a:
            java.util.Queue<com.google.firebase.iid.zzr<?>> r1 = r0.zznzd     // Catch:{ all -> 0x00ae }
            boolean r1 = r1.isEmpty()     // Catch:{ all -> 0x00ae }
            if (r1 == 0) goto L_0x0017
            r0.zzcjc()     // Catch:{ all -> 0x00ae }
            monitor-exit(r0)     // Catch:{ all -> 0x00ae }
            return
        L_0x0017:
            java.util.Queue<com.google.firebase.iid.zzr<?>> r1 = r0.zznzd     // Catch:{ all -> 0x00ae }
            java.lang.Object r1 = r1.poll()     // Catch:{ all -> 0x00ae }
            com.google.firebase.iid.zzr r1 = (com.google.firebase.iid.zzr) r1     // Catch:{ all -> 0x00ae }
            android.util.SparseArray<com.google.firebase.iid.zzr<?>> r3 = r0.zznze     // Catch:{ all -> 0x00ae }
            int r4 = r1.zzift     // Catch:{ all -> 0x00ae }
            r3.put(r4, r1)     // Catch:{ all -> 0x00ae }
            com.google.firebase.iid.zzi r3 = r0.zznzf     // Catch:{ all -> 0x00ae }
            java.util.concurrent.ScheduledExecutorService r3 = r3.zznyy     // Catch:{ all -> 0x00ae }
            com.google.firebase.iid.zzo r4 = new com.google.firebase.iid.zzo     // Catch:{ all -> 0x00ae }
        ...
        L_0x0066:
            com.google.firebase.iid.zzi r3 = r0.zznzf
            android.content.Context r3 = r3.zzair
            android.os.Messenger r4 = r0.zznzb
            ...
            android.os.Bundle r1 = r1.zznzj
            r4.putBundle(r3, r1)
            r5.setData(r4)
            com.google.firebase.iid.zzp r1 = r0.zznzc     // Catch:{ RemoteException -> 0x00a4 }
