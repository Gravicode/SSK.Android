...
public final class Schedulers {
    ...
    private static Schedulers getInstance() {
        while (true) {
            Schedulers current = (Schedulers) INSTANCE.get();
            if (current != null) {
                return current;
            }
