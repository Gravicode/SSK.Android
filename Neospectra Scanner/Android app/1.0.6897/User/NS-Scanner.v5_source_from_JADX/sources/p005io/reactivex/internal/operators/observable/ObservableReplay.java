...
public final class ObservableReplay<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T>, Disposable {
    ...
    static final class Replay<T> extends ConnectableObservable<T> {
        ...
        /* renamed from: co */
        private final ConnectableObservable<T> f336co;
        ...
        public void connect(Consumer<? super Disposable> connection) {
            this.f336co.connect(connection);
        }
    ...
    static final class ReplaySource<T> implements ObservableSource<T> {
        ...
        public void subscribe(p005io.reactivex.Observer<? super T> r6) {
            /*
                r5 = this;
            L_0x0000:
                ...
                io.reactivex.internal.operators.observable.ObservableReplay$ReplayObserver r0 = (p005io.reactivex.internal.operators.observable.ObservableReplay.ReplayObserver) r0
            ...
            L_0x0035:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p005io.reactivex.internal.operators.observable.ObservableReplay.ReplaySource.subscribe(io.reactivex.Observer):void");
        }
    }
    ...
    public static <T> ConnectableObservable<T> create(ObservableSource<T> source2, long maxAge, TimeUnit unit, Scheduler scheduler, int bufferSize) {
        ScheduledReplaySupplier scheduledReplaySupplier = new ScheduledReplaySupplier(bufferSize, maxAge, unit, scheduler);
        return create(source2, (BufferSupplier<T>) scheduledReplaySupplier);
    }
    ...
    public void connect(p005io.reactivex.functions.Consumer<? super p005io.reactivex.disposables.Disposable> r7) {
        ...
        L_0x004f:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: p005io.reactivex.internal.operators.observable.ObservableReplay.connect(io.reactivex.functions.Consumer):void");
    }
}
