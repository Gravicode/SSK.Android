...
public final class FlowableSkipLastTimed<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class SkipLastTimedSubscriber<T> extends AtomicInteger implements FlowableSubscriber<T>, Subscription {
        ...
        public void onSubscribe(Subscription s) {
            if (SubscriptionHelper.validate(this.f206s, s)) {
                this.f206s = s;
                ...
                while (true) {
                    ...
                    while (true) {
                        ...
                        if (!checkTerminated(d, empty, a, delayError3)) {
                            ...
                            q.poll();
                            boolean delayError4 = delayError3;
                            a.onNext(q.poll());
                            e++;
                            delayError3 = delayError4;
                        } else {
                            return;
                        }
                    }
    ...
    public void subscribeActual(Subscriber<? super T> s) {
        ...
        SkipLastTimedSubscriber skipLastTimedSubscriber = new SkipLastTimedSubscriber(s, this.time, this.unit, this.scheduler, this.bufferSize, this.delayError);
